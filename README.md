...
1. Töltsd le a Balena Etchert: https://etcher.balena.io/ zöld Download Etcher gomb,<sub> vagy közvetlenül: https://github.com/balena-io/etcher/releases/download/v2.1.0/balenaEtcher-2.1.0.Setup.exe | *Etcher helyett jó a Ventoy - leírása lejjebb. NE használj helyette ehhez a telepítőhöz ⛔ Rufust!</sub>.
