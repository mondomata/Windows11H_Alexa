...
A "csupasz" Windows használat megkezdése után találsz benne egy mappát, a tartalmát felhasználva könnyedén - megint csak "egyenesen, magyarul" - telepítheted kedvenc programjaidat. <sub>*Ennek a repostory-nak nem tárgya, hogy miért, de az tény, hogy ezt a Windows 11-t - minden másikkal egyezően - CSAK UEFI-s gépre érdemes telepíteni (GPT-re), a BIOS/MBR kerülendő! BIOS/MBR telepítés esetén együtt kell élni a lassú rendszer indítás mellett a tetemes teljesítmény csökkenéssel rendszer használat közben is.*</sub>
