...
- a telepítőben nincsenek specifikus drivertelepítők /ahogy a MS telpítőben sincs/, ha tudod, hogyan, ajánlott a te géped alaplap gyártó honlapjáról a chipset driver telepítőt, vagy drivereket előre beszerezve (intel driver telepítők az iso-ban vannak!) szintén az USB-re másolni, majd azonnal telepíteni az első indítás után<sub> ha nem tudod, lejjebb találsz más megoldást</sub>)
  </b>
